                            ...
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <a href="{{ url('addManu')}}" class="btn btn-success"
                                                data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add
                                                    New Manufacture</span></a>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        @foreach ($manu as $value)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('edit-manu/' . $value->manu_id) }}" class="edit"
                                                        data-toggle="modal"><i class="material-icons"
                                                            data-toggle="tooltip" title="Edit">&#xE254;</i>
                                                    </a>

                                                    <a href="delete/{{ $value->manu_id }}" class="delete"
                                                        data-toggle="modal"><i class="material-icons"
                    ...
                    <div id="addEmployeeModal" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('add-manu') }}" method="POST">
                                    @csrf
