                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('add-protype') }}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label>Protype ID</label>
                                    <input type="text" class="form-control" required name="protype_id"  placeholder="Protype ID">
                                  </div>
                              <div class="form-group">
                                <label>Protype Name</label>
                                <input type="text" class="form-control" required name="protype_name"  placeholder="Protype Name">
                              </div>
