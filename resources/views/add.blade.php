                          ...
                          <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('add-product') }}" method="POST">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="manu_id"  placeholder="Manufacture">
                              </div>
                              <div class="form-group">
                                <label>Protype</label>
                                <input type="text" class="form-control" required name="type_id" placeholder="Protype">
                              </div>
                              <div class="form-group">
                                <label>Price</label>
                              ...
                              <div class="form-group">
                                <label>Feature</label>
                                <input type="text" class="form-control" required name="feature" placeholder="Feature">
                              </div>
                              <div class="form-group">
                                <label>Sale</label>
                                <input type="text" class="form-control" required name="sale" placeholder="Sale">
                              </div>
