                            ...
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <a href="{{ url('addProtype')}}" class="btn btn-success"
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($protype as $value)
                                            @csrf
                                            <tr>
                                                <td>{{ $value->protype_id }}</td>
                                                <td>{{ $value->protype_name }}</td>
                                                <td>
                                                    <a href="{{ url('edit-protype/' . $value->protype_id) }}" class="edit"
                                                        data-toggle="modal"><i class="material-icons"
                                                            data-toggle="tooltip" title="Edit">&#xE254;</i>
                                                    </a>

                                                    <a href="delete/{{ $value->protype_id }}" class="delete"
                                                        data-toggle="modal"><i class="material-icons"
                    ...
                    <div id="addEmployeeModal" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('add-protype') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Protypes ID</label>
                                            <input type="text" class="form-control" required name="protype_id">
                                        </div>
                                        <div class="form-group">
                                            <label>Protypes Name</label>
                                            <input type="text" class="form-control" required name="protype_name">
                                        </div>
                                    </div>
